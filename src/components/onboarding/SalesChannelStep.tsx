  ...
  return (
    <div className="space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-gray-900">How do you sell your products today?</h2>
        <p className="text-gray-600">Select all that apply - this helps us customize your setup</p>
      </div>
        ...
        {options.map((option) => (
          <div
            ...
            className={`border rounded-lg p-4 cursor-pointer transition-all hover:bg-gray-50 ${
              data.salesChannels.includes(option.id) ? "border-blue-500 bg-blue-50" : "border-gray-200"
            }`}
